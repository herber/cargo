  ...
  return (function(t) {
                ...
                value: function() {
                  (this.el.SimpleBar = this),
                    ...
                    0 !== this.scrollbarWidth &&
                      (this.contentEl.style.marginRight = '-'.concat(this.scrollbarWidth, 'px')),
                    this.recalculate(),
                    this.initListeners();
                }
              },
                          ...
                          Array.from(e.addedNodes).forEach(function(e) {
                            1 === e.nodeType &&
                              (e.hasAttribute('data-simplebar')
                                ...
                                : Array.from(e.querySelectorAll('[data-simplebar]')).forEach(
                                    function(e) {
                                      !e.SimpleBar && new t(e, t.getElOptions(e));
                                    }
                                  ));
                            ...
                            Array.from(e.removedNodes).forEach(function(t) {
                              1 === t.nodeType &&
                                (t.hasAttribute('data-simplebar')
                                  ...
                                  : Array.from(t.querySelectorAll('[data-simplebar]')).forEach(
                                      function(t) {
                                        t.SimpleBar && t.SimpleBar.unMount();
                                      }
                                    ));
    ...
    function(t, e, n) {
      ...
      t.exports =
        ...
        function(t, e) {
          ...
          return (
            null !== t
              ? ((c.prototype = r(t)), (n = new c()), (c.prototype = null), (n[s] = t))
              : (n = a()),
            void 0 === e ? n : i(n, e)
          );
        };
    ...
    function(t, e, n) {
      ...
      function l(t) {
        ...
        return (
          E(s, { x: e, y: n, width: r, height: i, top: n, right: e + r, bottom: i + n, left: e }), s
        );
      }
      function f(t, e, n, r) {
