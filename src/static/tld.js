!(function($) {
  ...
  return (function() {
    return function $(a, o, i) {
      ...
      for (var n = 'function' == typeof require && require, s = 0; s < i.length; s++) e(i[s]);
      return e;
    };
  })()(
    {
      1: [
        function($, a, o) {
          'use strict';
          var i = $('./lib/suffix-trie.js').fromJson($('./rules.json')),
            e = $('./lib/clean-host.js'),
            n = $('./lib/domain.js'),
            s = $('./lib/public-suffix.js'),
            t = $('./lib/subdomain.js'),
            r = $('./lib/is-valid.js'),
            u = $('./lib/is-ip.js'),
            l = $('./lib/tld-exists.js'),
          ...
          a.exports = (function $(a) {
            ...
            function p($, a) {
              ...
              return null === e.hostname
                ? ((e.isIp = !1), (e.isValid = !1), e)
                : ((e.isIp = u(e.hostname)),
                  e.isIp
                    ? ((e.isValid = !0), e)
                    : ((e.isValid = r(e.hostname)),
                      !1 === e.isValid
                        ? e
                        : ((i !== d && i !== m) || (e.tldExists = l(o, e.hostname)),
                          i === m
                            ? e
                            : ((e.publicSuffix = s(o, e.hostname)),
                              i === c
                                ? e
                                : ((e.domain = n(k, e.publicSuffix, e.hostname)),
                                  i === h ? e : ((e.subdomain = t(e.hostname, e.domain)), e))))));
            }
            return {
              extractHostname: b,
              isValid: r,
              parse: p,
              tldExists: function($) {
                return p($, m).tldExists;
              },
              getPublicSuffix: function($) {
                return p($, c).publicSuffix;
              },
              getDomain: function($) {
                return p($, h).domain;
              },
              getSubdomain: function($) {
                return p($, g).subdomain;
              },
              fromUserSettings: $
            };
          })({});
      ...
      2: [
        function($, a, o) {
          var i = $('url'),
            ...
            n = /^(([a-z][a-z0-9+.-]*)?:)?\/\//;
          function s($) {
            return '.' === $[$.length - 1] ? $.substr(0, $.length - 1) : $;
          }
          a.exports = function($) {
            if (e($)) return s($);
            var a = $;
            'string' != typeof a && (a = '' + a);
            var o,
              t = (o = a).length > 0 && (o.charCodeAt(0) <= 32 || o.charCodeAt(o.length - 1) <= 32);
            t && (a = a.trim());
            var r = (function($) {
              for (var a = 0; a < $.length; a += 1) {
                var o = $.charCodeAt(a);
                if (o >= 65 && o <= 90) return !0;
              }
              return !1;
            })(a);
            if ((r && (a = a.toLowerCase()), (r || t) && e(a))) return s(a);
            n.test(a) || (a = '//' + a);
            var u = i.parse(a, null, !0);
            return u.hostname ? s(u.hostname) : null;
          };
        },
        { './is-valid.js': 6, url: 16 }
      ],
      3: [
        function($, a, o) {
          'use strict';
          a.exports = function($, a, o) {
            for (var i = 0; i < $.length; i += 1) {
              ...
              if (
                ...
                (r = void 0),
                (r = s = e),
                (t = n = o).lastIndexOf(r) === t.length - r.length &&
                  (n.length === s.length || '.' === n[n.length - s.length - 1]))
              )
                return e;
            }
            var n, s, t, r, u, l, m, c;
      ...
      6: [
        function($, a, o) {
          ...
          a.exports = function($) {
            if ('string' != typeof $) return !1;
            if ($.length > 255) return !1;
            if (0 === $.length) return !1;
            var a = $.charCodeAt(0);
            if (!e(a) && !i(a)) return !1;
            for (var o, n, s = -1, t = $.length, r = 0; r < t; r += 1) {
              if (46 === (n = $.charCodeAt(r))) {
                if (r - s > 64 || 46 === o || 45 === o) return !1;
                s = r;
              } else if (!e(n) && !i(n) && 45 !== n) return !1;
              o = n;
            }
            return t - s - 1 <= 63 && 45 !== o;
          };
        },
        {}
      ],
      7: [
        function($, a, o) {
          ...
          var i = $('./from-host.js');
          a.exports = function($, a) {
            if ($.hasTld(a)) return a;
            var o = $.suffixLookup(a);
            return null === o ? i(a) : o;
          };
        },
        { './from-host.js': 4 }
      ...
      8: [
        function($, a, o) {
          'use strict';
          a.exports = function($, a) {
            return null === a ? null : $.substr(0, $.length - a.length - 1);
          };
        },
        {}
      ],
      9: [
        function($, a, o) {
          ...
          var i = 0;
          function e($, a) {
            return null === $ ? a : null === a ? $ : $ < a ? $ : a;
          }
          function n($, a) {
            for (var o = $.parts, e = a, n = 0; n < o.length; n += 1) {
              var s = o[n],
                t = e[s];
              void 0 === t && ((t = Object.create(null)), (e[s] = t)), (e = t);
            }
            return (e.$ = i), a;
          }
          function s($, a, o) {
            ...
            return (
              ...
              -1 === o
                ? n
                : (void 0 !== (i = a[$[o]]) && (n = e(n, s($, i, o - 1))),
                  void 0 !== (i = a['*']) && (n = e(n, s($, i, o - 1))),
                  n)
            );
          }
          function t($) {
            if (((this.exceptions = Object.create(null)), (this.rules = Object.create(null)), $))
              for (var a = 0; a < $.length; a += 1) {
                var o = $[a];
                o.exception ? n(o, this.exceptions) : n(o, this.rules);
              }
          }
          (t.fromJson = function($) {
            var a = new t();
            return (a.exceptions = $.exceptions), (a.rules = $.rules), a;
          }),
            (t.prototype.hasTld = function($) {
              return void 0 !== this.rules[$];
            }),
            (t.prototype.suffixLookup = function($) {
              var a = $.split('.'),
                o = s(a, this.rules, a.length - 1);
              if (null === o) return null;
              var i = s(a, this.exceptions, a.length - 1);
              return null !== i ? a.slice(i + 1).join('.') : a.slice(o).join('.');
            }),
            (a.exports = t);
        },
        {}
      ...
      10: [
        function($, a, o) {
          ...
          var i = $('./from-host.js');
          a.exports = function($, a) {
            if ($.hasTld(a)) return !0;
            var o = i(a);
            return null !== o && $.hasTld(o);
          };
        },
        { './from-host.js': 4 }
      ],
        ...
        function($, a, o) {
          a.exports = {
            ...
            rules: {
              ...
              fi: { $: 0, aland: { $: 0 }, dy: { $: 0 }, blogspot: { $: 0 }, iki: { $: 0 } },
              fj: { '*': { $: 0 } },
              fk: { '*': { $: 0 } },
              fm: { $: 0 },
              fo: { $: 0 },
              ...
              ls: { $: 0, co: { $: 0 }, org: { $: 0 } },
              lt: { $: 0, gov: { $: 0 }, blogspot: { $: 0 }, nym: { $: 0 } },
              lu: { $: 0, blogspot: { $: 0 }, nym: { $: 0 } },
              lv: {
                $: 0,
                com: { $: 0 },
                edu: { $: 0 },
              ...
              nu: { $: 0, merseine: { $: 0 }, mine: { $: 0 }, shacknet: { $: 0 }, nom: { $: 0 } },
              nz: {
                $: 0,
                ac: { $: 0 },
                co: { $: 0, blogspot: { $: 0 } },
              ...
              si: { $: 0, blogspot: { $: 0 }, nom: { $: 0 } },
              sj: { $: 0 },
              sk: { $: 0, blogspot: { $: 0 }, nym: { $: 0 } },
              sl: {
                $: 0,
                com: { $: 0 },
                net: { $: 0 },
              ...
              horse: { $: 0 },
              hospital: { $: 0 },
              host: { $: 0, cloudaccess: { $: 0 }, freesite: { $: 0 } },
              ...
              sina: { $: 0 },
              singles: { $: 0 },
              site: { $: 0, cyon: { $: 0 }, platformsh: { '*': { $: 0 } }, byen: { $: 0 } },
              ski: { $: 0 },
              skin: { $: 0 },
              sky: { $: 0 },
              skype: { $: 0 },
              ...
              sony: { $: 0 },
              soy: { $: 0 },
              space: { $: 0, stackspace: { $: 0 }, uber: { $: 0 }, xs4all: { $: 0 } },
              spiegel: { $: 0 },
              spot: { $: 0 },
              spreadbetting: { $: 0 },
              srl: { $: 0 },
      ...
      12: [
        function($, a, o) {
          (function($) {
            !(function(i) {
              var e = 'object' == typeof o && o && !o.nodeType && o,
              ...
              function O($, a) {
                var o = $.split('@'),
                  i = '';
                return (
                  o.length > 1 && ((i = o[0] + '@'), ($ = o[1])),
                  i + q(($ = $.replace(y, '.')).split('.'), a).join('.')
                );
              }
              function C($) {
                for (var a, o, i = [], e = 0, n = $.length; e < n; )
                  (a = $.charCodeAt(e++)) >= 55296 && a <= 56319 && e < n
                    ? 56320 == (64512 & (o = $.charCodeAt(e++)))
                      ? i.push(((1023 & a) << 10) + (1023 & o) + 65536)
                      : (i.push(a), e--)
                    : i.push(a);
                return i;
              }
              function A($) {
                return q($, function($) {
                  ...
                  return (
                    $ > 65535 &&
                      ((a += z(((($ -= 65536) >>> 10) & 1023) | 55296)), ($ = 56320 | (1023 & $))),
                    (a += z($))
                  );
                }).join('');
              }
              function I($, a) {
                return $ + 22 + 75 * ($ < 26) - ((0 != a) << 5);
              }
              function U($, a, o) {
                var i = 0;
              ...
              function S($) {
                var a,
                  ...
                  x = k,
                  z = d;
                for ((o = $.lastIndexOf(b)) < 0 && (o = 0), i = 0; i < o; ++i)
                  $.charCodeAt(i) >= 128 && j('not-basic'), f.push($.charCodeAt(i));
                for (e = o > 0 ? o + 1 : 0; e < y; ) {
                  for (
                    n = v, s = 1, t = l;
                    e >= y && j('invalid-input'),
                      ((r =
                        ...
                        j('overflow'),
                      (v += r * s),
                      !(r < (h = t <= z ? m : t >= z + c ? c : t - z));
                    t += l
                  )
                    s > w(u / (g = l - h)) && j('overflow'), (s *= g);
                  (z = U(v - n, (a = f.length + 1), 0 == n)),
                    w(v / a) > u - x && j('overflow'),
                    (x += w(v / a)),
                    (v %= a),
                    f.splice(v++, 0, x);
                }
              ...
              function R($) {
                var a,
                  ...
                  x,
                  q = [];
                for (f = ($ = C($)).length, a = k, o = 0, n = d, s = 0; s < f; ++s)
                  (p = $[s]) < 128 && q.push(z(p));
                for (i = e = q.length, e && q.push(b); i < f; ) {
                  for (t = u, s = 0; s < f; ++s) (p = $[s]) >= a && p < t && (t = p);
                  for (
                    t - a > w((u - o) / (y = i + 1)) && j('overflow'),
                      o += (t - a) * y,
                      a = t,
                      s = 0;
                    s < f;
              ...
              if (
                ((t = {
                  ...
                  toUnicode: function($) {
                    return O($, function($) {
                      return p.test($) ? S($.slice(4).toLowerCase()) : $;
                    });
                  }
                }),
                e && n)
              )
                if (a.exports == e) n.exports = t;
      ...
      13: [
        function($, a, o) {
          ...
          a.exports = function($, a, o, e) {
            (a = a || '&'), (o = o || '=');
            var n = {};
            if ('string' != typeof $ || 0 === $.length) return n;
            var s = /\+/g;
            $ = $.split(a);
            var t = 1e3;
            e && 'number' == typeof e.maxKeys && (t = e.maxKeys);
            var r,
              u,
              l = $.length;
            t > 0 && l > t && (l = t);
            for (var m = 0; m < l; ++m) {
              var c,
                ...
                k = $[m].replace(s, '%20'),
                b = k.indexOf(o);
              b >= 0 ? ((c = k.substr(0, b)), (h = k.substr(b + 1))) : ((c = k), (h = '')),
        ...
        function($, a, o) {
          ...
          a.exports = function($, a, o, t) {
            return (
              ...
              'object' == typeof $
                ? n(s($), function(s) {
                    var t = encodeURIComponent(i(s)) + o;
                    return e($[s])
                      ? n($[s], function($) {
          ...
          function n($, a) {
            if ($.map) return $.map(a);
            for (var o = [], i = 0; i < $.length; i++) o.push(a($[i], i));
            return o;
          }
          var s =
            Object.keys ||
            function($) {
              var a = [];
              for (var o in $) Object.prototype.hasOwnProperty.call($, o) && a.push(o);
              return a;
            };
        },
        {}
      ...
      15: [
        function($, a, o) {
          'use strict';
          (o.decode = o.parse = $('./decode')), (o.encode = o.stringify = $('./encode'));
        },
        { './decode': 13, './encode': 14 }
      ],
      16: [
        function($, a, o) {
          ...
          (o.parse = f),
            (o.resolve = function($, a) {
              return f($, !1, !0).resolve(a);
            }),
            (o.resolveObject = function($, a) {
              return $ ? f($, !1, !0).resolveObject(a) : a;
            }),
            (o.format = function($) {
              e.isString($) && ($ = f($));
              return $ instanceof n ? $.format() : n.prototype.format.call($);
            }),
            (o.Url = n);
          var s = /^([a-z0-9.+-]+:)/i,
            t = /:[0-9]*$/,
            ...
            p = $('querystring');
          function f($, a, o) {
            if ($ && e.isObject($) && $ instanceof n) return $;
            var i = new n();
            return i.parse($, a, o), i;
          }
          (n.prototype.parse = function($, a, o) {
            if (!e.isString($))
            ...
            if (((f = f.trim()), !o && 1 === $.split('#').length)) {
              ...
              if (y)
                return (
                  ...
                  y[2]
                    ? ((this.search = y[2]),
                      (this.query = a ? p.parse(this.search.substr(1)) : this.search.substr(1)))
            ...
            if (v) {
              ...
              (this.protocol = x), (f = f.substr(v.length));
            }
            if (o || v || f.match(/^\/\/[^@\/]+@[^@\/]+/)) {
              var w = '//' === f.substr(0, 2);
              !w || (v && k[v]) || ((f = f.substr(2)), (this.slashes = !0));
            }
            if (!k[v] && (w || (v && !b[v]))) {
              for (var z, j, q = -1, O = 0; O < c.length; O++) {
                -1 !== (C = f.indexOf(c[O])) && (-1 === q || C < q) && (q = C);
              }
              -1 !== (j = -1 === q ? f.lastIndexOf('@') : f.lastIndexOf('@', q)) &&
                ((z = f.slice(0, j)), (f = f.slice(j + 1)), (this.auth = decodeURIComponent(z))),
                (q = -1);
              for (O = 0; O < m.length; O++) {
                var C;
                -1 !== (C = f.indexOf(m[O])) && (-1 === q || C < q) && (q = C);
              }
              -1 === q && (q = f.length),
                (this.host = f.slice(0, q)),
                (f = f.slice(q)),
                this.parseHost(),
                (this.hostname = this.hostname || '');
              var A = '[' === this.hostname[0] && ']' === this.hostname[this.hostname.length - 1];
              if (!A)
                for (var I = this.hostname.split(/\./), U = ((O = 0), I.length); O < U; O++) {
                  var S = I[O];
                  if (S && !S.match(h)) {
                    for (var R = '', E = 0, N = S.length; E < N; E++)
                      S.charCodeAt(E) > 127 ? (R += 'x') : (R += S[E]);
                    if (!R.match(h)) {
                      var T = I.slice(0, O),
                        L = I.slice(O + 1),
                        F = S.match(g);
            ...
            if (!d[x])
              for (O = 0, U = l.length; O < U; O++) {
                ...
                if (-1 !== f.indexOf(P)) {
                  ...
                  _ === P && (_ = escape(P)), (f = f.split(P).join(_));
                }
              }
            var D = f.indexOf('#');
            -1 !== D && ((this.hash = f.substr(D)), (f = f.slice(0, D)));
            var J = f.indexOf('?');
            if (
              (-1 !== J
                ? ((this.search = f.substr(J)),
                  (this.query = f.substr(J + 1)),
                  a && (this.query = p.parse(this.query)),
                  (f = f.slice(0, J)))
                : a && ((this.search = ''), (this.query = {})),
              f && (this.pathname = f),
            ...
            (n.prototype.format = function() {
              ...
              return (
                a && ':' !== a.substr(-1) && (a += ':'),
                this.slashes || ((!a || b[a]) && !1 !== n)
                  ? ((n = '//' + (n || '')), o && '/' !== o.charAt(0) && (o = '/' + o))
                  : n || (n = ''),
                i && '#' !== i.charAt(0) && (i = '#' + i),
                t && '?' !== t.charAt(0) && (t = '?' + t),
                a +
            ...
            (n.prototype.resolve = function($) {
              return this.resolveObject(f($, !1, !0)).format();
            }),
            (n.prototype.resolveObject = function($) {
              if (e.isString($)) {
                var a = new n();
                a.parse($, !1, !0), ($ = a);
              }
              for (var o = new n(), i = Object.keys(this), s = 0; s < i.length; s++) {
                var t = i[s];
                o[t] = this[t];
              }
              if (((o.hash = $.hash), '' === $.href)) return (o.href = o.format()), o;
              if ($.slashes && !$.protocol) {
                for (var r = Object.keys($), u = 0; u < r.length; u++) {
                  var l = r[u];
                  'protocol' !== l && (o[l] = $[l]);
                }
                return (
                  b[o.protocol] && o.hostname && !o.pathname && (o.path = o.pathname = '/'),
                  (o.href = o.format()),
                  o
                );
              }
              if ($.protocol && $.protocol !== o.protocol) {
                if (!b[$.protocol]) {
                  for (var m = Object.keys($), c = 0; c < m.length; c++) {
                    var h = m[c];
                    o[h] = $[h];
                  }
                  return (o.href = o.format()), o;
                }
                if (((o.protocol = $.protocol), $.host || k[$.protocol])) o.pathname = $.pathname;
                else {
                  for (var g = ($.pathname || '').split('/'); g.length && !($.host = g.shift()); );
                  $.host || ($.host = ''),
                    $.hostname || ($.hostname = ''),
                    '' !== g[0] && g.unshift(''),
                ...
                return (o.slashes = o.slashes || $.slashes), (o.href = o.format()), o;
              }
              var f = o.pathname && '/' === o.pathname.charAt(0),
                y = $.host || ($.pathname && '/' === $.pathname.charAt(0)),
              ...
              if (
                (z &&
                  ((o.hostname = ''),
                  (o.port = null),
                  o.host && ('' === w[0] ? (w[0] = o.host) : w.unshift(o.host)),
                  (o.host = ''),
                  $.protocol &&
                    (($.hostname = null),
                    ($.port = null),
                    $.host && ('' === g[0] ? (g[0] = $.host) : g.unshift($.host)),
                    ($.host = null)),
                  (v = v && ('' === g[0] || '' === w[0]))),
                y)
              )
                (o.host = $.host || '' === $.host ? $.host : o.host),
                  (o.hostname = $.hostname || '' === $.hostname ? $.hostname : o.hostname),
                  (o.search = $.search),
                  (o.query = $.query),
                  (w = g);
              else if (g.length)
                w || (w = []),
                  ...
                  (o.search = $.search),
                  (o.query = $.query);
              else if (!e.isNullOrUndefined($.search)) {
                if (z)
                  (o.hostname = o.host = w.shift()),
                    (A = !!(o.host && o.host.indexOf('@') > 0) && o.host.split('@')) &&
                      ((o.auth = A.shift()), (o.host = o.hostname = A.shift()));
                return (
                  (o.search = $.search),
                  (o.query = $.query),
                  (e.isNull(o.pathname) && e.isNull(o.search)) ||
                    (o.path = (o.pathname ? o.pathname : '') + (o.search ? o.search : '')),
                  (o.href = o.format()),
                  o
                );
              }
              ...
              for (
                var j = w.slice(-1)[0],
                  q = ((o.host || $.host || w.length > 1) && ('.' === j || '..' === j)) || '' === j,
                  O = 0,
                  C = w.length;
                C >= 0;
                C--
              ...
              z &&
                ((o.hostname = o.host = I ? '' : w.length ? w.shift() : ''),
                (A = !!(o.host && o.host.indexOf('@') > 0) && o.host.split('@')) &&
                  ((o.auth = A.shift()), (o.host = o.hostname = A.shift())));
              return (
                (v = v || (o.host && w.length)) && !I && w.unshift(''),
                w.length ? (o.pathname = w.join('/')) : ((o.pathname = null), (o.path = null)),
                (e.isNull(o.pathname) && e.isNull(o.search)) ||
                  (o.path = (o.pathname ? o.pathname : '') + (o.search ? o.search : '')),
                (o.auth = $.auth || o.auth),
                (o.slashes = o.slashes || $.slashes),
                (o.href = o.format()),
                o
              );
            }),
